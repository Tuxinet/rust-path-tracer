...
impl VecUtil {
    #[inline]
    pub fn random(min: f64, max: f64, rng: &mut Lehmer) -> Vector3<f64> {
        return Vector3::<f64>::new(rng.gen_range(min, max), rng.gen_range(min, max), rng.gen_range(min, max));
    }

    #[inline]
    pub fn random_in_unit_sphere(rng: &mut Lehmer) -> Vector3<f64> {
        loop {
    ...
    #[inline]
    pub fn random_unit_vector(rng: &mut Lehmer) -> Vector3<f64> {
    ...
    #[inline]
    pub fn random_in_hemisphere(normal: Vector3<f64>, rng: &mut Lehmer) -> Vector3<f64> {
    ...
    #[inline]
    pub fn random_in_unit_disk(rng: &mut Lehmer) -> Vector3<f64> {
        loop {
